...
*/
var current_users = ["Muhammad", "Arif", "Salman", "Arslan", "Aslam", "Zohaib"];
var new_users = ["arslan", "zohaib", "salman", "Badar", "Kashif"];
...
new_users.forEach(function (new_user) {
    ...
    if (usernameTaken) {
        console.log("".concat(new_user, " needs to choose a newuser name because it's already taken"));
    }
    else {
